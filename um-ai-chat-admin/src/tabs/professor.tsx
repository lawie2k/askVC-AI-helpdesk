export default function professor(){
    ...
    <div className="flex justify-center justify-self-center text-[32px] font-bold bg-[#900C27] rounded-full w-[250px] h-[50px] ">
      ...
      <div className="w-[1170px] h-[650px]  mt-12 mx-10 flex-col ">
        <input type="text" className="w-[200px] mr-2 px-2 text-black" placeholder="name" />
        <input type="text" className="w-[200px] mr-2 px-2 text-black" placeholder="position"/>
        <input type="text" className="w-[200px] mr-2 px-2 text-black" placeholder="email"/>
        <input type="text" className="w-[200px] mr-2 px-2 text-black" placeholder="department"/>
